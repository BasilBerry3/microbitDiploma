...
| **Терморегуляция** | 🌡️ Измерение температуры | [Читать материал](./Lessons/LesBio2.md) | [Запустить Tutorial](https://makecode.microbit.org/#tutorial:39023-47955-27265-78953) |
| **Сердечно-сосудистая система** | ❤️ Пульсометр | [Читать материал](./Lessons/LesBio3.md) | [Запустить Tutorial](ссылка_из_tools) |
| **Экология** | 🌱 Мониторинг среды | [Читать материал](./Lessons/LesBio4.md) | [Запустить Tutorial](ссылка_из_tools) |
